 ...
 *  \see getMarginValue
 */
    inline void setMarginValue(QMargins& margins,
                               QCP::MarginSide side,
                               int value) {
        switch (side) {
...
public:
    ...
    Q_DECLARE_FLAGS(PainterModes, PainterMode) QCPPainter();
...
public:
    ...
    friend inline const QCPRange operator -
    (const QCPRange &range, double value);
...
class QCP_LIB_DECL QCPLayoutGrid: public QCPLayout{
    ...
    Q_PROPERTY(
        QList < double >
        columnStretchFactors READ columnStretchFactors WRITE setColumnStretchFactors)
    Q_PROPERTY(
        QList < double >
        rowStretchFactors READ rowStretchFactors WRITE setRowStretchFactors)
...
class QCP_LIB_DECL QCPAxis: public QCPLayerable{
    ...
    Q_PROPERTY(QVector < double >
               tickVector READ tickVector WRITE setTickVector)
    Q_PROPERTY(
        QVector < QString >
...
public:
    ...
    Q_ENUMS(GradientPreset) QCPColorGradient(GradientPreset preset = gpCold);
...
class QCP_LIB_DECL QCPPlottableLegendItem: public QCPAbstractLegendItem{
    Q_OBJECT
public:
    QCPPlottableLegendItem(QCPLegend * parent,
                           QCPAbstractPlottable * plottable);
...
protected:
    ...
    const QPolygonF getChannelFillPolygon(const QVector < QPointF >
                                          * lineData) const;
...
typedef QMutableMapIterator < double,
    QCPCurveData > QCPCurveDataMutableMapIterator;
...
typedef QMutableMapIterator < double,
    QCPFinancialData > QCPFinancialDataMutableMapIterator;
...
protected:
    enum AnchorIndex {aiTop, aiTopRight, aiRight, aiBottom, aiBottomLeft,
                      aiLeft};
...
class QCP_LIB_DECL QCPItemText: public QCPAbstractItem{
    ...
    Q_PROPERTY(QString text READ text WRITE setText)
    Q_PROPERTY(
        Qt::Alignment positionAlignment READ positionAlignment WRITE setPositionAlignment)
    Q_PROPERTY(
...
protected:
    enum AnchorIndex {aiTopLeft, aiTop, aiTopRight, aiRight, aiBottomRight,
                      aiBottom, aiBottomLeft, aiLeft};
...
protected:
    enum AnchorIndex {aiTopLeftRim, aiTop, aiTopRightRim, aiRight,
...
public:
    ...
    Q_ENUMS(TracerStyle) QCPItemTracer(QCustomPlot * parentPlot);
